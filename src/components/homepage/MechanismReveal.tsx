 ...
 * Phase 1: Uses Framer Motion scroll transforms (GSAP ScrollTrigger in Phase 2).
 */
export function MechanismReveal() {
  ...
  const carOpacity = useTransform(scrollYProgress, [0.6, 0.9], [0, 1]);
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 flex h-screen items-center justify-center overflow-hidden bg-bg-primary">
        ...
        <motion.div
          className="absolute inset-0 bg-gradient-to-b from-bg-secondary to-bg-primary"
        ...
        <div className="relative z-10 mx-auto w-full max-w-[900px] px-4">
          ...
          <div className="relative flex items-center justify-center">
            {/* Left panel */}
            <motion.div
              className="relative z-10 h-[300px] w-[280px] rounded-l-2xl bg-gradient-to-r from-bg-card to-bg-secondary border border-border-subtle md:h-[400px] md:w-[320px]"
              style={{ x: leftPanelX }}
            >
            ...
            {/* Center panel */}
            <motion.div
              className="relative z-20 flex h-[320px] w-[320px] items-center justify-center rounded-2xl bg-gradient-to-b from-bg-card to-bg-primary border border-accent-gold/30 shadow-2xl shadow-accent-gold/10 md:h-[440px] md:w-[400px]"
            ...
            {/* Right panel */}
            <motion.div
              className="relative z-10 h-[300px] w-[280px] rounded-r-2xl bg-gradient-to-l from-bg-card to-bg-secondary border border-border-subtle md:h-[400px] md:w-[320px]"
              style={{ x: rightPanelX }}
            >
              <div className="flex h-full items-center justify-center">
                <span className="text-4xl text-text-tertiary">⟐</span>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-sm text-text-secondary">
                Your vehicle, perfectly protected
              </p>
            </div>
          </motion.div>
        </div>
