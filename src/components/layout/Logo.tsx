...
export function WasleenGarageLogo({
  ...
  const c = inverted ? '#FFFFFF' : '#1A1A1A';
  ...
  return (
    ...
    >
      {inverted ? (
        ...
        <g>
          ...
          <path
            ...
            stroke={c} strokeWidth="6" strokeLinecap="round" strokeLinejoin="round" fill="none"
          />

          {/* Rafters */}
          <line x1="42" y1="72" x2="158" y2="72" stroke={c} strokeWidth="3.5" strokeLinecap="round" opacity={0.9} />
          <line x1="38" y1="82" x2="162" y2="82" stroke={c} strokeWidth="3" strokeLinecap="round" opacity={0.8} />
          <line x1="35" y1="92" x2="165" y2="92" stroke={c} strokeWidth="2.5" strokeLinecap="round" opacity={0.6} />

          {/* Columns */}
          <rect x="30" y="95" width="10" height="88" rx="4" fill={c} />
          <rect x="160" y="95" width="10" height="88" rx="4" fill={c} />

          {/* Column Capitals */}
          <rect x="28" y="93" width="14" height="4" rx="2" fill={c} opacity={0.8} />
          <rect x="158" y="93" width="14" height="4" rx="2" fill={c} opacity={0.8} />

          {/* Grills — Lattice */}
          <g opacity={0.35} stroke={c} strokeWidth="1.5">
            <line x1="40" y1="110" x2="160" y2="150" />
            <line x1="40" y1="130" x2="160" y2="170" />
            <line x1="40" y1="150" x2="160" y2="190" />
            <line x1="160" y1="110" x2="40" y2="150" />
            <line x1="160" y1="130" x2="40" y2="170" />
            <line x1="160" y1="150" x2="40" y2="190" />
          </g>

          {/* Horizontal Divider Bars */}
          <g opacity={0.25} stroke={c} strokeWidth="1.5">
          ...
          {/* Base Platform */}
          <rect x="26" y="183" width="148" height="4" rx="2" fill={c} opacity={0.2} />
        </g>
      ) : (
        /* ─── Default (gold gradient) version ─── */
        <g>
          {/* Gold Gradient */}
          <defs>
      ...
      {/* Wordmark (rendered as SVG text for perfect alignment) */}
      {showWordmark && (
